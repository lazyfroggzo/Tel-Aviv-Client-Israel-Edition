...
public class HUD extends Function {
    ...
    public final Dragging watermarkDrag = TelAviv.getInstance().createDrag(this, "WaterMark", 10, 10);
    public final Dragging targethudDrag = TelAviv.getInstance().createDrag(this, "TargetHUD", 10, 45);
    public final Dragging keybindsDrag = TelAviv.getInstance().createDrag(this, "KeyBindsHUD", 10, 95);
    public final Dragging stafflistDrag = TelAviv.getInstance().createDrag(this, "StaffListHUD", 10, 128);
    public final Dragging itemcooldownDrag = TelAviv.getInstance().createDrag(this, "CoolDownHUD", 10, 165);
    public final Dragging potionhudDrag = TelAviv.getInstance().createDrag(this, "PotionHUD", 10, 198);
    public final Dragging coordinateshudDrag = TelAviv.getInstance().createDrag(this, "CoordinatesHUD", 10, 198);
    public final Dragging armorDrag = TelAviv.getInstance().createDrag(this, "ArmorHUD", 478, 468);
    ...
    private void waterMark(EventRender2D render2D) {
        ...
        String textLogo = "TelAviv 1.21.4";
