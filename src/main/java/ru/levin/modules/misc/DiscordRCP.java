...
public class DiscordRCP extends Function {
    ...
    public synchronized void startRpc() {
        ...
        presence.largeImageText = "https://t.me/telaviv";
    ...
    private void updatePresenceFields() {
        ...
        presence.button_url_1 = "https://telaviv.ru";
        presence.button_label_2 = "Телеграмм";
        presence.button_url_2 = "https://t.me/telaviv";

        presence.largeImageKey = "https://api.telaviv.ru/api/loader/discord.gif";
    }
